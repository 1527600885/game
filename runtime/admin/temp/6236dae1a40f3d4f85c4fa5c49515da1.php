<?php /*a:3:{s:48:"E:\soft\unggame\app\admin\view\config\index.html";i:1679909414;s:49:"E:\soft\unggame\app\admin\view\common\header.html";i:1673339170;s:49:"E:\soft\unggame\app\admin\view\common\footer.html";i:1672902372;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<el-tab-pane label="平台配置" name="ungconfig">
				<div class="el-pane-warp">
					<el-form ref="ungForm" :model="ungForm" label-width="150px">
						...
						<el-form-item label="用户协议：" prop="ung_user_agreement">
							<el-editor v-model="ungForm.ung_user_agreement"  placeholder="请填写用户协议"></el-editor>
						</el-form-item>
						<el-form-item label="隐私政策：" prop="ung_privacy_olicy">
							<el-editor v-model="ungForm.ung_privacy_olicy"  placeholder="请填写隐私政策"></el-editor>
						</el-form-item>
					</el-form>
					<div class="el-bottom">
						<el-button
